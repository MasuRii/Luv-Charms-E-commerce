...
export default function HomePageContent({ featuredProducts }: HomePageContentProps) {
  return (
    <motion.div
      ...
      >
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          >
            <Link
              href="/shop"
              className="inline-block rounded-full px-8 py-3 text-base font-semibold shadow-lg"
